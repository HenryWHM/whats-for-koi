class FoodItem {
  ...
  FoodItem({this.text = "", this.veg = false, this.breakfast = false, this.brunch = false, this.lunch = false, this.dinner = false, this.dessert = false, this.title = false, this.override = false});
}
